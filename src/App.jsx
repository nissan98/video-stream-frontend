...
function App() {
  ...
  const uploadChunk = async (file, last, MAX_SIZE, current_chunk, end, destination, isEnd = false) => {
    ...
    headers.append('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOiI2ODllMDEyZjhmNzZmZGMyNGY4OTBmNWMiLCJ1c2VybmFtZSI6ImJoZWxhMTMyIiwiZW1haWwiOiJiaGVsYTIyMkBnbWFpbC5jb20iLCJpYXQiOjE3NTUxOTAyNzUsImV4cCI6MTc1NTIwMTA3NX0.DcprMD5OZfZFrlgXeXzZeo53XBx2L1NJ5LFhUxeTT6U');
    const options = {
      method: 'POST',
      headers: headers,
      body: formData
