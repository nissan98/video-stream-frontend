...
export default function Home() {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 flex flex-col relative overflow-x-hidden">
            {/* Decorative blurred circles */}
            <div className="absolute top-[-120px] left-[-120px] w-[300px] h-[300px] bg-blue-900 rounded-full blur-3xl opacity-30 z-0"></div>
            <div className="absolute bottom-[-100px] right-[-100px] w-[250px] h-[250px] bg-blue-700 rounded-full blur-2xl opacity-20 z-0"></div>
            <Navbar />
            <main className="flex-1 flex flex-col items-center justify-center px-4 relative z-10">
                <h1 className="text-5xl md:text-6xl font-extrabold text-blue-200 mb-4 text-center drop-shadow-xl tracking-tight">
                ...
                <a
                    href=""
                    className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white px-8 py-3 rounded-2xl font-bold text-xl shadow-xl transition-all duration-200 mb-12"
                >
